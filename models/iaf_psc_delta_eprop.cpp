...
double
nest::iaf_psc_delta_eprop::Parameters_::set( const DictionaryDatum& d, Node* node )
{
...
void
nest::iaf_psc_delta_eprop::State_::get( DictionaryDatum& d, const Parameters_& p ) const
{
  def< double >( d, names::V_m, y3_ + p.E_L_ ); // Membrane potential
}

void
nest::iaf_psc_delta_eprop::State_::set( const DictionaryDatum& d, const Parameters_& p, double delta_EL, Node* node )
{
